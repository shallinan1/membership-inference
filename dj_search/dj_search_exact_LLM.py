...
python3 -m dj_search.dj_search_exact_LLM \
    --task bookMIA \
    --output_dir /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/coverages/ \
    --gen_data /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/generations/gpt2-large_maxTokens512_numSeq20_topP0.95_numSent3_startSent1_promptIdx0_len788_2024_10-03-00:35:53.jsonl \
    --min_ngram 4 \
    --parallel;
...
python3 -m dj_search.dj_search_exact_LLM \
    --task bookMIA \
    --output_dir /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/coverages/ \
    --gen_data /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/generations/gpt-4o-2024-05-13_maxTokens512_numSeq10_topP0.95_numSent3_startSent1_promptIdx5_len788.jsonl \
    --min_ngram 4;
    
python3 -m dj_search.dj_search_exact_LLM \
    --task bookMIA \
    --output_dir /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/coverages/ \
    --gen_data /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/generations/gpt-4o-2024-05-13_maxTokens512_numSeq10_topP0.95_numSent5_startSent1_promptIdx5_len788.jsonl \
    --min_ngram 4;

python3 -m dj_search.dj_search_exact_LLM \
    --task bookMIA \
    --output_dir /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/coverages/ \
    --gen_data /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/generations/gpt-4o-2024-05-13_maxTokens512_numSeq10_topP0.95_numSent3_startSent1_promptIdx0_len788.jsonl \
    --min_ngram 4;

python3 -m dj_search.dj_search_exact_LLM \
    --task bookMIA \
    --output_dir /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/coverages/ \
    --gen_data /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/generations/gpt-4o-2024-05-13_maxTokens512_numSeq10_topP0.95_numSent5_startSent1_promptIdx0_len788.jsonl \
    --min_ngram 4;

python3 -m dj_search.dj_search_exact_LLM \
    --task bookMIA \
    --output_dir /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/coverages/ \
    --gen_data /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/generations/gpt-4o-2024-05-13_maxTokens512_numSeq10_topP0.95_numSent3_startSent1_promptIdx4_len788.jsonl \
    --min_ngram 4;

python3 -m dj_search.dj_search_exact_LLM \
    --task bookMIA \
    --output_dir /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/coverages/ \
    --gen_data /gscratch/xlab/hallisky/membership-inference/tasks/bookMIA/generations/gpt-4o-2024-05-13_maxTokens512_numSeq10_topP0.95_numSent5_startSent1_promptIdx4_len788.jsonl \
    --min_ngram 4;
"""